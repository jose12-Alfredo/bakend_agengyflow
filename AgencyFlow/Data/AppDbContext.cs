...
public class AppDbContext : DbContext
{
    ...
    public DbSet<ProjectDirectorAccess> ProjectDirectorAccesses => Set<ProjectDirectorAccess>();
    public DbSet<Notification> Notifications => Set<Notification>();
    public DbSet<ProjectStatusHistory> ProjectStatusHistories => Set<ProjectStatusHistory>();
    public DbSet<SubProjectStatusHistory> SubProjectStatusHistories => Set<SubProjectStatusHistory>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProjectDirectorAccess>()
            .HasIndex(access => new { access.ProjectId, access.DirectorUserId })
            .IsUnique()
            .HasFilter("\"DeletedAt\" IS NULL");
        modelBuilder.Entity<ProjectDirectorAccess>()
            .HasOne(access => access.GrantedByUser).WithMany()
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.HasIndex(notification => new { notification.UserId, notification.DedupeKey })
                .IsUnique()
        ...
        modelBuilder.Entity<ProjectStatusHistory>(entity =>
        {
            ...
            entity.HasIndex(history => new { history.ProjectId, history.Timestamp });
            entity.HasOne(history => history.Project).WithMany(project => project.StatusHistory)
                .HasForeignKey(history => history.ProjectId).OnDelete(DeleteBehavior.Cascade);
        });
        modelBuilder.Entity<SubProjectStatusHistory>(entity =>
        {
            entity.ToTable("subproject_status_history");
            entity.HasIndex(history => new { history.SubProjectId, history.Timestamp });
            entity.HasOne(history => history.SubProject).WithMany(project => project.StatusHistory)
                .HasForeignKey(history => history.SubProjectId).OnDelete(DeleteBehavior.Cascade);
        });
