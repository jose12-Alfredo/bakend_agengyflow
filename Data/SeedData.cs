...
public static class SeedData
{
    ...
    {
        const string passwordHash = "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy";

        modelBuilder.Entity<User>().HasData(
            new User { Id = Id("44444444-4444-4444-4444-444444444401"), FirstName = "Vernica", LastName = "Paz", Email = "vernica.paz@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111102"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444402"), FirstName = "Vanet", LastName = "Garcia", Email = "vanet.garcia@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111103"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444403"), FirstName = "Anto", LastName = "Pomacusi", Email = "anto.pomacusi@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111103"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444404"), FirstName = "Carlos", LastName = "Apala", RoleId = Id("11111111-1111-1111-1111-111111111101"), ClientCompanyId = Id("33333333-3333-3333-3333-333333333301"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444405"), FirstName = "Harold", LastName = "Apaza", RoleId = Id("11111111-1111-1111-1111-111111111101"), ClientCompanyId = Id("33333333-3333-3333-3333-333333333302"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444406"), FirstName = "Miguel", LastName = "Calvimontes", RoleId = Id("11111111-1111-1111-1111-111111111101"), ClientCompanyId = Id("33333333-3333-3333-3333-333333333303"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444407"), FirstName = "Yoss", LastName = "Quiroga", Email = "yoss.quiroga@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111104"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444408"), FirstName = "Belen", LastName = "Rodriguez", Email = "belen.rodriguez@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111105"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444409"), FirstName = "Gabriel", LastName = "Aguilar", Email = "gabriel.aguilar@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111104"), CreatedAt = SeedDate },
            new User { Id = Id("44444444-4444-4444-4444-444444444410"), FirstName = "Ariane", LastName = "Alvarez", Email = "ariane.alvarez@gmail.com", Password = passwordHash, RoleId = Id("11111111-1111-1111-1111-111111111104"), CreatedAt = SeedDate });
    }
    ...
    private static void ConfigureDepartmentUsers(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DepartmentUser>().HasData(
            ...
            new DepartmentUser { Id = Id("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa01"), UserId = Id("44444444-4444-4444-4444-444444444402"), DepartmentId = Id("22222222-2222-2222-2222-222222222202"), CreatedAt = SeedDate },
            new DepartmentUser { Id = Id("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa02"), UserId = Id("44444444-4444-4444-4444-444444444403"), DepartmentId = Id("22222222-2222-2222-2222-222222222203"), CreatedAt = SeedDate },
            new DepartmentUser { Id = Id("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa03"), UserId = Id("44444444-4444-4444-4444-444444444403"), DepartmentId = Id("22222222-2222-2222-2222-222222222204"), CreatedAt = SeedDate },
