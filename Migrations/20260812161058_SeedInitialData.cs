    ...
    public partial class SeedInitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("44444444-4444-4444-4444-444444444401"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "vernica.paz@gmail.com", "Vernica", "Paz", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111102"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444402"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "vanet.garcia@gmail.com", "Vanet", "Garcia", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111103"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444403"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "anto.pomacusi@gmail.com", "Anto", "Pomacusi", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111103"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444404"), new Guid("33333333-3333-3333-3333-333333333301"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, "Carlos", "Apala", null, null, new Guid("11111111-1111-1111-1111-111111111101"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444405"), new Guid("33333333-3333-3333-3333-333333333302"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, "Harold", "Apaza", null, null, new Guid("11111111-1111-1111-1111-111111111101"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444406"), new Guid("33333333-3333-3333-3333-333333333303"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, "Miguel", "Calvimontes", null, null, new Guid("11111111-1111-1111-1111-111111111101"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444407"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "yoss.quiroga@gmail.com", "Yoss", "Quiroga", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111104"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444408"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "belen.rodriguez@gmail.com", "Belen", "Rodriguez", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111105"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444409"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "gabriel.aguilar@gmail.com", "Gabriel", "Aguilar", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111104"), null, null },
                    { new Guid("44444444-4444-4444-4444-444444444410"), null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "ariane.alvarez@gmail.com", "Ariane", "Alvarez", "$2b$11$nimYdExq5VFLkLlkcI2/aeCSrdXHIIZ8ytITFH13EMfcIM8LWB4Sy", null, new Guid("11111111-1111-1111-1111-111111111104"), null, null }
                });
